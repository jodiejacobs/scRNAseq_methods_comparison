#!/bin/bash
#SBATCH --job-name=cells_integrate_h5ad
#SBATCH --output=/private/groups/russelllab/jodie/scRNAseq/pipseq/cell_pipseq/v1_by_condition/logs/out/10x_integrate_h5ad_%j.out
#SBATCH --error=/private/groups/russelllab/jodie/scRNAseq/pipseq/cell_pipseq/v1_by_condition/logs/error/10x_integrate_h5ad_%j.err
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUTPUT_DIR="/private/groups/russelllab/jodie/scRNAseq/pipseq/cell_pipseq/v1_by_condition/integrated_h5ad"
