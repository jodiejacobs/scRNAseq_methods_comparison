...
#SBATCH --output=/private/groups/russelllab/jodie/scRNAseq/pipseq/ovary_pipseq/v1_by_condition/logs/out/wolbachia_analysis_%j.out
#SBATCH --error=/private/groups/russelllab/jodie/scRNAseq/pipseq/ovary_pipseq/v1_by_condition/logs/error/wolbachia_analysis_%j.err
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
FIGURES_DIR="/private/groups/russelllab/jodie/scRNAseq/pipseq/ovary_pipseq/v1_by_condition/figures"
