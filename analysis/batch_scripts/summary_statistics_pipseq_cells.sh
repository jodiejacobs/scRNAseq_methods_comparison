#!/bin/bash
#SBATCH --job-name=cell_pip_summary_statistics
#SBATCH --output=/private/groups/russelllab/jodie/scRNAseq/pipseq/cell_pipseq/v1_by_condition/logs/out/summary_stats_%j.out
#SBATCH --error=/private/groups/russelllab/jodie/scRNAseq/pipseq/cell_pipseq/v1_by_condition/logs/error/summary_stats_%j.err
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RESULTS_DIR="/private/groups/russelllab/jodie/scRNAseq/pipseq/cell_pipseq/v1_by_condition/summary_statistics"
