#!/bin/bash
#SBATCH --job-name=10x_summary_statistics
#SBATCH --output=/private/groups/russelllab/jodie/scRNAseq/10x/cellranger_results_v4/v1_by_conditon/logs/out/summary_stats_%j.out
#SBATCH --error=/private/groups/russelllab/jodie/scRNAseq/10x/cellranger_results_v4/v1_by_conditon/logs/error/summary_stats_%j.err
#SBATCH --time=1:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
INTEGRATED_DIR="/private/groups/russelllab/jodie/scRNAseq/10x/cellranger_results_v4/v1_by_conditon/integrated_h5ad"
RESULTS_DIR="/private/groups/russelllab/jodie/scRNAseq/10x/cellranger_results_v4/v1_by_conditon/summary_statistics"
